import type { AvatarColors, StudioAvatar } from '../avatar/avatars'
import type { AvatarMouth } from '../avatar/mouth'
...
export const serializeAvatarSnapshot = (
  ...
  mouth?: AvatarMouth,
  avatar?: Pick<StudioAvatar, 'logoMorph' | 'faceForward'>,
  faceReveal = 1
) => {
  ...
  const body = [
    ...scene.backPaths.map((item, index) =>

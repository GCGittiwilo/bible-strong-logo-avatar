...
const english: Record<string, string> = {
  ...
  'Faire parler': 'Talk',
  'Arrêter de parler': 'Stop talking',
  Réfléchir: 'Think',
  'Arrêter de réfléchir': 'Stop thinking',
  'Afficher le visage': 'Show face',
  'Afficher le logo': 'Show logo',
  'Le symbole respire doucement avant de révéler son visage.':
    'The symbol gently breathes before revealing its face.',
  ...
  'Face Locked Spins': 'Face Locked Spins',
  'Face Attached Spins': 'Face Attached Spins',
  Loading: 'Loading',
  'Horizontal 360': 'Horizontal 360',
  'Vertical 360': 'Vertical 360',
  'Roll 360': 'Roll 360',
  'Diagonal Orbit': 'Diagonal Orbit',
  Gyroscope: 'Gyroscope',
  ...
  'Comportement du visage': 'Face behavior',
  'Visage verrouillé': 'Face locked',
  'Visage attaché au corps': 'Face attached to body',
  'Regard coordonné': 'Coordinated gaze',
  Calme: 'Calm',
  Attentif: 'Attentive',
  Réfléchi: 'Reflective',
  Balayage: 'Scanning',
...
const frenchStates: Record<string, string> = {
  ...
  complete: 'terminé',
  error: 'erreur',
  'Chat Pipeline': 'Pipeline de conversation',
  'Face Locked Spins': 'Rotations visage verrouillé',
  'Face Attached Spins': 'Rotations visage attaché',
  Loading: 'Chargement',
  'Horizontal 360': 'Rotation horizontale 360',
  'Vertical 360': 'Rotation verticale 360',
  'Roll 360': 'Roulis 360',
  'Diagonal Orbit': 'Orbite diagonale',
  Gyroscope: 'Gyroscope',

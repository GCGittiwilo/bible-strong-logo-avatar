export const chinese: Record<string, string> = {
  ...
  'Faire parler': '开始说话',
  'Arrêter de parler': '停止说话',
  Réfléchir: '思考',
  'Arrêter de réfléchir': '停止思考',
  'Afficher le visage': '显示面孔',
  'Afficher le logo': '显示标志',
  'Le symbole respire doucement avant de révéler son visage.': '标志轻柔呼吸，然后显露出面孔。',
  ...
  Réactions: '反应',
  'Chat Pipeline': '对话流程',
  'Face Locked Spins': '面部锁定旋转',
  'Face Attached Spins': '面部随动旋转',
  Loading: '加载',
  'Horizontal 360': '水平旋转 360',
  'Vertical 360': '垂直旋转 360',
  'Roll 360': '翻滚 360',
  'Diagonal Orbit': '对角轨道',
  Gyroscope: '陀螺仪',
  ...
  'Comportement du visage': '面部行为',
  'Visage verrouillé': '面部锁定',
  'Visage attaché au corps': '面部随身体移动',
  'Regard coordonné': '协调视线',
  Calme: '平静',
  Attentif: '专注',
  Réfléchi: '思考',
  Balayage: '扫描',

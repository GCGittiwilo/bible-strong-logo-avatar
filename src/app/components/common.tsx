        ...
        <motion.g style={{ x: scene.offsetX, y: scene.offsetY }}>
          {scene.backPaths.map((pathValue, index) => (
            <motion.path
              d={pathValue}
              fill={colors.body}
              opacity={scene.backPathOpacities[index]}
              key={`back-${index}`}
            />
          ))}
          <motion.path
          ...
          >
            ...
            {avatar.mouth && (
              <>
                <motion.path d={scene.mouthPath} fill={avatar.mouth.color} />
                <motion.path d={scene.tonguePath} fill={avatar.mouth.tongueColor} />
              </>
            )}
          </motion.g>
          {scene.frontPaths.map((pathValue, index) => (
            <motion.path
              d={pathValue}
              fill={colors.body}
              opacity={scene.frontPathOpacities[index]}
              key={`front-${index}`}
            />
          ))}
        </motion.g>
